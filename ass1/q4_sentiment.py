...
### YOUR CODE HERE
# [0, 10**-5, ..., 10**0.5]
REGULARIZATION = np.concatenate((np.array([0]), np.logspace(-7,-1,9)))
### END YOUR CODE
...
for regularization in REGULARIZATION:
    ...
    print "Training for reg=%E" % regularization 
...
### YOUR CODE HERE 
dev_accuracy, train_accuracy, BEST_REGULARIZATION, BEST_WEIGHTS = \
  max((res["dev"],res["train"],res["reg"],res["weights"]) \
    for res in results)
print "Best Result:"
print "------------"
print "Train accuracy=%E" % trainAccuracy
print "Dev accuracy  =%E" % dev_accuracy
print "Train accuracy=%E" % train_accuracy
print "regularization=%E" % BEST_REGULARIZATION
...
plt.savefig("results/q4_reg_v_acc.png")
plt.show()
