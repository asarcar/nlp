...
def softmax(x):
  ...
  ### YOUR CODE HERE
  te = tf.exp(x - tf.reduce_max(x, axis=1, keep_dims=True))
  out = te/tf.reduce_sum(te, axis=1, keep_dims=True)
  ### END YOUR CODE
...
def cross_entropy_loss(y, yhat):
  ...
  """
  ### YOUR CODE HERE
  xent = -tf.log(tf.reduce_max(tf.to_float(y)*yhat, axis=1, keep_dims=True)) 
  out  = tf.reduce_mean(xent)
  ### END YOUR CODE
